...
{		$row_client_data =$result_client_data->fetch_assoc();
		...
		echo ('
            ...
            <td>
            <form method="post" action="email_bill_individual.php"> 
            <input type="hidden" name="gst_uid" value='.$row_gst_data["uid"].'>   
           <input type="submit" value="Email Bill" name="button1"/> </form></td>	

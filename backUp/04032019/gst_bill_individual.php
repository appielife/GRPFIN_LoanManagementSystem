...
$sql_gst= "SELECT *  FROM `gst_info` WHERE `fk_clients_info_uid` = $uid AND `invoice_date` BETWEEN  '$from' and '$to'  ";
		...
		<tr>
			<td style="border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=10 height="20"
				align="left" valign=top sdnum="1033;0;@"><b>
					<font face="Arial" color="#000000">INR'.convertNumberToWordsForIndia($total_amount).'</font>
				</b></td>
		</tr>
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000"

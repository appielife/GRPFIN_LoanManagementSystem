...
$via = $_POST['via'];
$bro_to=$_POST['bro_to'];
$security_chk=$_POST['security_chk'];
...
<br>";
 ...
 $SQL="INSERT INTO `transactions_record`(`RID`, `FROM`, `TO`, `AMOUNT`, `INTREST_RATE`, `INTREST_AMT`, `BROKERAGE_RATE`, `BROKERAGE_AMOUNT`, `CURR_DATE`, `DUE_DATE`, `VIA`, `DUE`,`DURATION`, `SECURITY_CHK` , `BROKERAGE_TO`) VALUES('$rid','$from','$to',$amount,$int_rate,$int_amt,$bro_rate,$bro_amt,'$curr_date','$curr_date','$via','Y', '$duration','$security_chk' ,'$bro_to')";
 if (mysqli_query($conn,$SQL)) {
            ...
            <td colspan="1"> Duration<br> <div class="tableData">'.$duration.' month(s)</div></td>
            </tr>
            ...
            <td colspan="2"> <div class="tableData">'.($security_chk).'</div></td>
            </tr>

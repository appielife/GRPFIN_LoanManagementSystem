...
<td class=details>  ' . date("j M Y", strtotime($from)) . ' - ' . date("j M Y", strtotime($to)) . '</td>
<td>GST</td>
<td class=details>' . $row0["GST"] . ' </td>
</tr>
<tr>
<td>Reference</td>
<td class=details>' . $row0["REFERENCE"] . ' </td>
<td>Email</td>
<td class=details>' . $row0["EMAIL"] . ' </td>
</tr>
</table>
</div>
<BR>
